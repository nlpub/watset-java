...
public class TogetherClusteringTest {
    private final TogetherClustering<String, DefaultWeightedEdge> together = TogetherClustering.<String, DefaultWeightedEdge>builder().build(ChineseWhispersTest.DISJOINT);
