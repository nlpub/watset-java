...
public class WatsetTest {
    ...
    private final static Watset<String, DefaultWeightedEdge> watset = Watset.<String, DefaultWeightedEdge>builder().setLocal(local).setGlobal(global).build(SenseInductionTest.WORDS);
