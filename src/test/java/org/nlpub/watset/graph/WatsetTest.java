...
public class WatsetTest {
    ...
    private final static Watset<String, DefaultWeightedEdge> watset = Watset.<String, DefaultWeightedEdge>builder().setLocal(local).setGlobal(global).apply(Fixtures.WORD_GRAPH);
